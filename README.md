...
You can install the released version of `MicroBiotR` from [GitHub](https://github.com/changlabs/MicroBiotR) with the following R commands:
...
![MBR Circle Plot](figure/circle.png)
![MBR Violin Plot](figure/violin.png)
![MBR PCOA Plot](figure/pcoa.png)
...
```
![MBR FS Plot1](figure/fs1.png)
![MBR FS Plot2](figure/fs2.png)
![MBR FS Plot3](figure/fs3.png)
![MBR Heatmap Plot](figure/heatmap.png)
![MBR Correlation Plot](figure/cor.png)
...
```
![MBR ROC Plot](figure/roc.png)
![MBR Confusion_Matrix Plot](figure/conf.png)
...
dat <- MBR_process(
  fcs_files,
  file_index = 70,                                    # index of the FCS file to process
...
![MBR 16S ROC plot](figure/16S.png)
...
![MBR transcriptomics ROC plot](figure/RNA.png)
